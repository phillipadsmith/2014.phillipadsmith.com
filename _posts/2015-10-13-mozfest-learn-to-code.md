...
Just when many thought the the “evils” of building Web apps with vanilla JavaScript or jQuery had received a steak through the heart (mandatory Halloween reference…) thanks to libraries like Backbone, a whole new era of solutions like Angular and Ember matured, and then — very shortly after — a whole new cohort emerged: React, Flux, and more. And all of this has happened in the last *few years!*
