---
layout: post
title: "Announcing a new journalism entrepreneurship bootcamp: Let's reboot the media together"
...
The De Correspondent model was simply *too big* to be directly relevant to their situation -- that is, often working in a traditional newsroom and just starting to *think* about these ideas, or freelancing and wanting to get off the hamster wheel and *focus on reporting stories that they have a passion for*.

Maybe you know someone like that? If so, you might want to share this post with them, [because I’m going to tell you, and your colleagues, where you can start](http://journalismentrepreneurship.com).
...
**I believe that this approach to mentoring works so well that I’ve decided to turn it into an 8-12 week online "journalism entrepreneurship bootcamp."  **It’s custom-made for experienced journalists of all stripes who are ready to embark on starting their own enterprise. Specifically, this will be fine-tuned for people who are ready to create a viable business that undertakes reporting, or produces information. You heard it here first. [And you can signal your interest today](journalismentrepreneurship.com).
...
Here’s the good news: I believe I’ve figured out enough of the answers to that question to package them up and bring them to life as an 8-12 week online bootcamp. [And I’m looking for a few passionate reporters to help me pilot the program](journalismentrepreneurship.com).
...
* The eight-week curriculum will be followed by an optional three week "open journalism leadership academy." The concept of open journalism is analogous to public-powered journalism and engaged journalism: bringing lessons from the open-source software movement -- co-creation, community idea solicitation, value exchange, and building networks around common interests  -- into the world of reporting.

And the most important detail is that [you can take the first step today](journalismentrepreneurship.com).

The pilot will launch in early fall. And right now I’m looking for a few brave and passionate journalists to be the first participants. If you’re ready to start work building the job of your dreams, where you can be your own boss and work on stories that matter to your community, you should [apply for the pilot](journalismentrepreneurship.com) and make that dream a reality.

If you’re just dipping your toes in the water, [sign up for updates](journalismentrepreneurship.com) and -- after we’ve stress-tested the curriculum, format, and infrastructure this fall -- we’ll start accepting applications for the public program launch in the spring of 2019.
...
* In partnership with Google News Lab, I spent two years travelling the globe [producing high-value experiences for aspiring media entrepreneurs](http://connect.hackshackers.com/). You can get a sense of the events here and here.
